...
SECRET_KEY = 'django-insecure-g=^l9ff8)=-3e_-yn^+0=rp33$c0j+h!lbx7mqel6*(%k$9o21'
...
JAZZMIN_SETTINGS = {
    ...
    "site_logo": "img/user.jpg",

    # Logo to use for your site, must be present in static files, used for login form logo (defaults to site_logo)
    "login_logo": "img/user.jpg",
    ...
    "welcome_sign": "News 24 admin paneliga xush kelibsiz!",
